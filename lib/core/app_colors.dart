...
class AppColors {
  static final Color background = Color(0xFF0A0B13);
  ...
  static final Color placeholder = Color(0xFFEBEBF0);
  ...
  static final Color backgroundCoinModal = Color(0xFF0A0B13);

  static final Color valueUp = Color(0xFF4CAD34);
  static final Color valueDown = Color(0xFFAD3434);
}
